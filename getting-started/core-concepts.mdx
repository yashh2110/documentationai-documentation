...
Being AI native means Documentation.AI uses AI and AI-integrated features throughout the product to support bo mth writers and readers. Structured components remain important, but they are one part of a broader, AI-driven workflow.
...
```csharp
asasdasd asdasdasd asdas dasdasd
```
...
- Use the built-in AI agent to read documentation efficiently.
...
<Tabs>
  <Tab title="Tab 1">
    Content for tab 1...asdasd
  </Tab>

  <Tab title="Tab 2">
    Content for tab 2...asdasd
  </Tab>
</Tabs>

<Steps>
  <Step title="First Step" title-type="p">
    Describe the first step here...adasd
  ...
  <Step title="New Step" title-type="p">
    Description for tasdasdhis step...
  </Step>
</Steps>

<CodeGroup show-lines="true" tabs={["new-file.txt"]}>
  ```text
  // Add your code hereasdasdasd
  ```

  ```text new-file.txt
  // Add your code hereasdaasdasdas
  ```
</CodeGroup>
...
<ParamField path="param" param-type="string" required="false" deprecated="false" show-location="true">
...
- Import schemas with [OpenAPI Import](/api-documentation-and-playground/openapi-importk).
