...
---
<Update label="2026-04-24" description="Preview branches, AI assistant polish, deployment filtering, and more reliable deploys" tags={["feature","improvement","fix"]}>
  ## Preview branches and deployments

  Preview branches and deployment flows are now easier to work with, so you can review changes before they go live and keep production releases moving cleanly. See [Code Editor](/write-and-publish/code-editor) for the Git-based preview and deployment workflow.

  ## AI assistant settings and styling

  AI assistant configuration is clearer, and the assistant UI has received styling improvements for a cleaner in-doc experience. See [AI Assistant](/ai/ai-assistant) and [Site Configuration](/customize/site-configuration) for setup details.

  ## Deployment list filtering and reliability

  Deployment lists are easier to scan with improved filtering, and deploy reliability has been improved to reduce failed or stuck publish flows.
</Update>
