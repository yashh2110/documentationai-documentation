...
**Layout patterns:**
- Columns with Cards: Wrap Cards directly in the Columns component with `cols="2"`
- Columns with plain content: Wrap content in a div inside the Columns component with `cols="2"`
